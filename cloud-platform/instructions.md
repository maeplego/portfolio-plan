...
8. `cloud-platform/chat-context/` をファイル名昇順で全て

アプリを載せる作業では、そのアプリの `DESIGN.md` も読む。チャット記録は `P02_XXXXX_要約.md`。独立リポジトリは `pf-cloud-aws` / `pf-cloud-k8s` / `pf-cloud-o11y`。
