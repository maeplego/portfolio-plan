...
- **パターン 2（連携）**: P05↔P10、P08+P03、P03+P01、P15+P01、P16+P09 などはメニュー内で連携オプションを選択
- レビューパック（P01+P03 / P04 / P06）は `review-up.ps1` に委譲
- ホストポート: P10 API **8091**、P10 web **3011**、P02 demo-api **8088**、P16 **8020**（他 Pxx との競合回避済み）
- P16: `.\scripts\demo.ps1 -Key p16`（規制名乗りなしのデモ明細。採用カタログに「給与できます」と書かない）
