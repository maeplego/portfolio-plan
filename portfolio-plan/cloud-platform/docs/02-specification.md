...
| 対象スライス | 実装済みの Compose / overlay A–C / Terraform validate |
| 最終更新 | 2026-08-19 |
...
| overlay | kustomize の用途別束。A/B/C は実装済み、D–F は計画 |
...
未実装 overlay D/E/F を「完成」と書かない。apply すると欠ける Deployment がある。
