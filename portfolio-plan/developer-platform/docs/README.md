...
| 対象スライス | scanner MVP + CLI/templates 実装済み。portal / CI dashboard / review は計画 |
| 最終更新 | 2026-08-19 |
| 矛盾時の正 | `../pf-developer-scanner` / `../pf-developer-cli` / `../pf-developer-templates` のテストとコード、次に `../DESIGN.md` |
...
| [02-specification.md](02-specification.md) | 外部仕様書（CLI 振る舞い） |
| [03-design.md](03-design.md) | 内部設計書 |
| [04-test-spec.md](04-test-spec.md) | テスト仕様書 |
| [05-api.md](05-api.md) | CLI / scanner 契約（HTTP ポータルは計画） |
...
| portal / oasdiff Action / CI dash / review | 計画 | 受け入れに含めない |
